...
public class GUIApp2 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		// View
		GUIView2 guiView1 = new GUIView2(); // replacing this with GUIView2 instance changes the view
		GUIView2 guiView2 = new GUIView2(); // replacing this with GUIView2 instance changes the view
